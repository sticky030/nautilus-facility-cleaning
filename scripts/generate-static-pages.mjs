          ...
          <div class="area-layout">
            ...
            <div class="cta">
              <div>
                ...
                <h2>Praxisfläche prüfen lassen und objektbezogenes Angebot erhalten.</h2>
                <p>
              ...
              <a class="button" href="https://nautilus-facility.de/?kontakt=1#kontakt" onclick="sessionStorage.setItem(\'scrollToContact\', \'1\')">Anfrage stellen</a>
            </div>
          </div>
        </div>
      </section>
    ...
    <footer>
      <div class="container">
        <div class="footer-grid">
          ...
          <div>
            ...
            <div class="footer-links">
              <a href="#leistungen">Leistungsumfang Praxisreinigung</a>
              <a href="#leistungen">4-Farben-Tuchsystem</a>
              <a href="#leistungen">RKI/KRINKO-orientierte Reinigungslogik</a>
              <a href="#leistungen">Reinigung von Kontaktflächen</a>
              <a href="#leistungen">Sanitär- und Oberflächenreinigung</a>
            </div>
          </div>
        ...
        <div class="footer-meta">
          ...
          <span>Arztpraxis Reinigung</span>
          <span>Zahnarztpraxis Reinigung</span>
          <span>Privatpraxis Reinigung</span>
