...
const css = `
      ...
      .horizontal-process-track::after {
        content:"";
        position:absolute;
        left: calc(12.5% + 22px);
        top: 22px;
      ...
      @keyframes horizontalPulse { 0%{box-shadow:0 0 0 0 rgba(183,155,108,.46)} 100%{box-shadow:0 0 0 18px rgba(183,155,108,0)} }
      @media(max-width:980px){
        .horizontal-process-track{grid-template-columns:1fr; gap:0;}
        .horizontal-process-track::before,.horizontal-process-track::after{display:none;}
        .horizontal-step{min-height:0; display:grid; grid-template-columns:44px 1fr; gap:18px; padding-bottom:24px;}
