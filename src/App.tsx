  ...
  return (
    <div className="min-h-screen bg-[#F7F4EE] text-[#6F6559] antialiased selection:bg-[#B79B6C]/20 shadow-md hover:shadow-xl hover:-translate-y-0.5 hover:bg-[#a3885c] transition-all duration-300">
      <div className="fixed inset-x-0 top-0 z-50">
        <header className="fixed top-4 inset-x-4 md:inset-x-auto md:left-1/2 md:-translate-x-1/2 md:w-[90%] md:max-w-6xl z-50 bg-white/75 backdrop-blur-xl rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-white/80 px-6 py-3 transition-all duration-500">
          ...
          <div className="flex items-start gap-4">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-[#9C8F7F]">
                ...
                <br />
                <a href="mailto:" className="hover:underline"></a>
                <br />
                <a href="mailto:" className="hover:underline"></a>
              </p>
            </div>
