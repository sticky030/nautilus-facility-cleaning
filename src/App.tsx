  ...
  return (
    <div className="min-h-screen bg-[#F7F4EE] text-[#6F6559] antialiased selection:bg-[#B79B6C]/20 scroll-smooth">
      <div className="fixed inset-x-0 top-6 z-50 flex justify-center px-4 pointer-events-none text-left">
        <header className="pointer-events-auto w-full max-w-6xl rounded-full bg-white/85 backdrop-blur-xl border border-white/60 shadow-lg px-4 py-3 transition-all duration-500">
      ...
      <main className="overflow-x-hidden">
        <section id="start" className="relative h-screen flex items-center overflow-hidden">
          ...
          <div className="relative mx-auto grid w-full max-w-7xl px-6 pb-20 pt-36 lg:px-10 text-left">
            <div className="reveal opacity-0 translate-y-10 lg:max-w-3xl">
              ...
              <h1 className="text-[38px] md:text-[62px] font-medium leading-[1.1] text-[#2C2C2C]">Exzellenz in der Reinigung.<br />Für anspruchsvolle Objekte.</h1>
              ...
              <div className="mt-12"><a href="#kontakt" className="inline-flex items-center justify-center rounded-full bg-[#B79B6C] px-9 py-4 text-[14px] font-bold uppercase tracking-wider text-white shadow-xl transition-all hover:-translate-y-1">Besichtigung anfragen</a></div>
            </div>
          </div>
        </section>
        ...
        <section id="leistungen" className="bg-[#F7F4EE] py-32 lg:py-40 text-left">
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            <div className="reveal opacity-0 translate-y-10 max-w-3xl mb-20">
            ...
            <div className="grid grid-cols-1 gap-8 xl:grid-cols-3">
              {services.map((s, idx) => (
                <article key={idx} className="reveal opacity-0 translate-y-10 bg-white p-10 rounded-3xl border border-[#E5E1D8] shadow-sm hover:shadow-2xl transition-all transform-gpu hover:-translate-y-2 flex flex-col h-full">
                  ...
                  <ul className="space-y-4 border-t pt-8 text-sm italic">
                    {s.bullets.map((b, j) => (<li key={j} className="flex items-center gap-3"><span className="h-1.5 w-1.5 rounded-full bg-[#B79B6C]" />{b}</li>))}
                  </ul>
                </article>
              ))}
            </div>
        ...
        <section id="warum-nautilus" className="bg-white py-32 lg:py-40 text-left border-y border-[#E5E1D8]/60">
          <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-12 gap-16 items-start">
            <div className="reveal opacity-0 translate-y-10 lg:col-span-5">
            ...
            <div className="lg:col-span-7 grid sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="reveal opacity-0 translate-y-10 p-10 rounded-3xl border border-[#E5E1D8] bg-[#FCFBF8] shadow-sm transition-all hover:bg-white"><h4 className="text-[10px] font-bold uppercase text-[#B79B6C] mb-4">{item.t}</h4><p className="text-[15px] leading-relaxed text-[#7E7367]">{item.d}</p></div>
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#F7F4EE] py-32 lg:py-48 text-left">
          <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-2 gap-20 items-center text-[#6F6559]">
            <div className="reveal opacity-0 translate-y-10">
              ...
              <p className="text-[#7E7367] leading-relaxed mb-6 font-light">Wir verstehen uns als unsichtbaren, aber essenziellen Teil Ihres Unternehmenserfolgs. Ein tadellos gepflegtes Erscheinungsbild unserer Mitarbeiter und absolute Verschwiegenheit sind für uns obligatorisch.</p>
              <p className="text-[#7E7367] leading-relaxed italic">Gerade in Notariaten, Privatpraxen und Vorstandsetagen zählt nicht die reine Anwesenheit des Personals – sondern die Fähigkeit zur Präzision.</p>
            </div>
            <div className="reveal opacity-0 translate-y-10 rounded-3xl overflow-hidden shadow-2xl"><img src="/images/nautilus-cleaning-team-berlin.jpg" alt="Team" className="w-full object-cover" /></div>
          </div>
        </section>

        <section id="ablauf" className="bg-white py-32 lg:py-40 text-left border-y border-[#E5E1D8]/60">
          <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-12 gap-16 items-start">
            <div className="reveal opacity-0 translate-y-10 lg:col-span-5 lg:sticky lg:top-40">
              ...
              <p className="mt-10 text-[18px] leading-8 text-[#8A7E70] font-light">Wir überlassen nichts dem Zufall, sondern definieren jeden Schritt für eine lautlose Integration.</p>
            </div>
            <div className="lg:col-span-7 space-y-6">
              {[
                { s: '01 · Fundierte Bedarfsanalyse', t: 'Wir analysieren Ihr Objekt vor Ort, um ein präzises Verständnis für Architektur und Diskretionsvorgaben zu entwickeln.' },
                { s: '02 · Strategische Konzeption', t: 'Maßarbeit statt Standard. Wir entwerfen ein hybrides Reinigungskonzept für Ihren individuellen Anspruch.' },
                { s: '03 · Präzise Implementierung', t: 'Lautlose Integration in Ihren Alltag. Unser Stammpersonal wird objektspezifisch instruiert.' },
                ...
                <div key={idx} className="reveal opacity-0 translate-y-10 rounded-3xl border border-[#E5E1D8] bg-[#FCFBF8] p-10 shadow-sm transition-all hover:bg-white"><div className="text-[11px] font-bold uppercase text-[#B79B6C]">{item.s}</div><p className="mt-5 text-[16px] leading-8 text-[#7E7367]">{item.t}</p></div>
              ))}
            </div>
          </div>
        </section>
            ...
            <div>
              ...
              <div className="mt-14 space-y-6">
                {[
                  ...
                  { t: 'Qualität', c: 'Feste Teams, geschultes Personal und absolute Zuverlässigkeit ab dem ersten Tag.' },
                  { t: 'Einsatzgebiet', c: 'Mitte · Pankow · Lichtenberg · Marzahn · Friedrichshain-Kreuzberg' }
                ].map((box, idx) => (
                  <div key={idx} className="rounded-3xl border border-[#E5E1D8] bg-white p-8 shadow-sm"><p className="text-[10px] font-bold uppercase text-[#B79B6C] mb-2">{box.t}</p><p className="text-[#6F6559] text-[16px] leading-8">{box.c}</p></div>
                ))}
              </div>
            </div>
            <div className="reveal opacity-0 translate-y-10 rounded-[40px] border border-[#E5E1D8] bg-white p-10 shadow-2xl lg:p-14">
              <form action="https://formspree.io/f/mnjonren" method="POST" className="space-y-8">
                ...
                <button type="submit" className="w-full rounded-2xl bg-[#B79B6C] px-6 py-5 text-[15px] font-bold uppercase tracking-wider text-white hover:bg-[#A98E60] transition-all">Anfrage senden</button>
              </form>
            </div>
          </div>
        </section>
