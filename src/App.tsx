...
const services = [
  ...
  },
  {
    ...
    bullets: [
      'Baufeinreinigung bis zur Bezugsfertigkeit',
    ...
    <div className="min-h-screen bg-[#F7F4EE] text-[#6F6559] antialiased selection:bg-[#B79B6C]/20 scroll-smooth">
      ...
      <main className="overflow-x-hidden">
        <section id="start" className="relative isolate flex min-h-screen items-center overflow-hidden bg-[#F3EFE7]">
          <video autoPlay muted loop playsInline className="absolute inset-0 h-full w-full object-cover pointer-events-none">
          ...
          <div className="relative mx-auto grid w-full max-w-7xl px-6 pb-20 pt-36 lg:px-10 lg:pb-28 lg:pt-40">
            <div className="reveal opacity-0 translate-y-10 transition-all duration-1000 lg:max-w-3xl">
              ...
              <div className="mt-12 flex flex-col gap-4 sm:flex-row sm:items-center">
                <a href="#kontakt" className="inline-flex items-center justify-center rounded-full bg-[#B79B6C] px-9 py-4 text-[14px] font-bold uppercase tracking-wider text-white shadow-[0_8px_20px_rgba(183,155,108,0.25)] transition-all duration-300 hover:-translate-y-0.5">Besichtigung anfragen</a>
              ...
              {services.map((service, idx) => (
                <article key={service.title} style={{ transitionDelay: `${idx * 150}ms` }} className="reveal opacity-0 translate-y-10 transition-all duration-1000 group flex flex-col h-full overflow-hidden rounded-3xl border border-[#E5E1D8] bg-white p-10 shadow-[0_8px_20px_rgba(0,0,0,0.02)] transition-all duration-500 ease-out hover:-translate-y-2 transform-gpu hover:border-[#B79B6C]/50 hover:shadow-[0_30px_60px_rgba(183,155,108,0.12)]">
                  ...
                  <div className="mt-10 flex flex-col justify-end shrink-0">
                    ...
                    <ul className="mt-8 flex flex-col justify-start gap-4 h-auto md:h-[200px] lg:h-[240px] xl:h-[220px] text-[15px] leading-6 text-[#6F6559] text-left">
        ...
        <section className="bg-white py-24 border-y border-[#E5E1D8]/60 overflow-hidden">
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <section id="warum-nautilus" className="bg-[#F7F4EE] py-32 lg:py-40">
          <div className="mx-auto max-w-7xl px-6 lg:px-10 grid grid-cols-1 gap-16 lg:grid-cols-12 items-start">
            <div className="reveal opacity-0 translate-y-10 transition-all duration-1000 lg:col-span-5 lg:pr-10 text-left">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 gap-6 sm:grid-cols-2 text-left">
              {[
                ...
                <article key={item.title} style={{ transitionDelay: `${idx * 100}ms` }} className="reveal opacity-0 translate-y-10 transition-all duration-1000 rounded-3xl border border-[#E5E1D8] bg-white p-10 hover:-translate-y-2 transform-gpu shadow-sm transition-all duration-500">
        ...
        <section className="bg-white py-32 lg:py-48 relative overflow-hidden border-y border-[#E5E1D8]/60">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-10 relative z-10 grid grid-cols-1 gap-16 lg:grid-cols-12 lg:items-center">
            <div className="reveal opacity-0 translate-y-10 transition-all duration-1000 lg:col-span-5 lg:pr-6 text-left">
              ...
              <p className="mt-5 text-[17px] leading-8 text-[#8A7E70] font-light">Gerade in Notariaten, Privatpraxen und Vorstandsetagen zählt nicht die reine Anwesenheit – sondern die Fähigkeit zur Präzision.</p>
            </div>
            <div className="reveal opacity-0 translate-y-10 transition-all duration-1000 lg:col-span-7">
              <div className="relative overflow-hidden rounded-3xl border border-[#E5E1D8] bg-white shadow-[0_20px_50px_rgba(183,155,108,0.1)]">
                <img src="/images/nautilus-cleaning-team-berlin.jpg" alt="Team" className="mx-auto w-full max-h-[550px] object-cover hover:scale-105 transition-transform duration-1000 transform-gpu" />
              </div>
            </div>
          </div>
        </section>

        <section id="ablauf" className="bg-[#F7F4EE] py-32 lg:py-40">
          <div className="mx-auto max-w-7xl px-6 lg:px-10 grid grid-cols-1 gap-16 lg:grid-cols-12 text-left">
            ...
            <div className="lg:col-span-7 space-y-6">
              {[
                ...
                <article key={item.step} style={{ transitionDelay: `${idx * 100}ms` }} className="reveal opacity-0 translate-y-10 transition-all duration-1000 rounded-3xl border border-[#E5E1D8] bg-white p-10 transform-gpu shadow-sm hover:shadow-md transition-all duration-500">
            ...
            <div className="grid items-start gap-20 lg:grid-cols-2 text-left">
              <div className="reveal opacity-0 translate-y-10 transition-all duration-1000">
                ...
                <div className="mt-14 space-y-6">
                  {[
                    { title: 'Zielgruppen', content: 'Arztpraxen, Kanzleien, Hausverwaltungen und anspruchsvolle Gewerbeeinheiten.' },
                    { title: 'Einsatzgebiet & SEO', content: 'Premium Reinigungsservice in: Mitte, Pankow, Lichtenberg, Marzahn sowie Friedrichshain-Kreuzberg.' },
                    { title: 'Qualitätssicherung', content: 'Feste Ansprechpartner, geschultes Stammpersonal und absolute Zuverlässigkeit.' }
                  ].map((box) => (
                ...
                <form id="contact-form" action="https://formspree.io/f/mnjonren" method="POST" className="space-y-8">
                  <div className="grid gap-6 sm:grid-cols-2">
                    <div className="relative">
                      ...
                      <div className="absolute inset-y-0 right-0 flex items-center px-5 text-[#B79B6C] pointer-events-none mt-7"><svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg></div>
                    </div>
                    <div className="relative">
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    <input type="text" name="Name" required placeholder="Ihr Name" className="w-full rounded-2xl border border-[#E5E1D8] bg-[#FCFBF8] px-6 py-4 text-[15px] outline-none focus:border-[#B79B6C] focus:bg-white" />
                    <input type="email" name="E-Mail" required placeholder="E-Mail" className="w-full rounded-2xl border border-[#E5E1D8] bg-[#FCFBF8] px-6 py-4 text-[15px] outline-none focus:border-[#B79B6C] focus:bg-white" />
                  </div>
                  <textarea rows={4} name="Nachricht" required placeholder="Objektbeschreibung..." className="w-full rounded-2xl border border-[#E5E1D8] bg-[#FCFBF8] px-6 py-4 text-[15px] outline-none focus:border-[#B79B6C] focus:bg-white resize-none" />
                  <button type="submit" className="w-full rounded-2xl bg-[#B79B6C] px-6 py-5 text-[15px] font-bold uppercase tracking-wider text-white transition-all duration-300 hover:bg-[#A98E60] hover:shadow-xl">Anfrage senden</button>
                </form>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-white py-16 border-t border-[#E5E1D8]">
        <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 lg:flex-row lg:items-start lg:justify-between lg:px-10 text-left">
          <div>
            <div className="text-[11px] font-bold tracking-[0.35em] text-[#B79B6C]">NAUTILUS FACILITY CLEANING</div>
            <p className="mt-5 max-w-md text-[14px] leading-7 text-[#8A7E70]">Professionelle Gebäudereinigung, Praxisreinigung und Kanzleireinigung in Berlin Mitte, Pankow, Lichtenberg, Marzahn sowie Friedrichshain-Kreuzberg.</p>
          </div>
