  ...
  return (
    <section id="faq" className="bg-white py-32 lg:py-40 border-b border-[#E5E1D8]/60 text-left">
      <div className="mx-auto max-w-4xl px-6 lg:px-10">
        <div className="reveal opacity-0 translate-y-10 mb-16">
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            <div key={idx} className="reveal opacity-0 translate-y-10 border-b border-[#E5E1D8] last:border-0">
              <button 
              ...
              <div className={`transition-all duration-500 ease-in-out ${openIndex === idx ? 'max-h-[400px] pb-8 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
